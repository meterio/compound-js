...
import type { CToken, CTokenInterface } from "../../../contracts/CToken/CToken";
...
export class CToken__factory {
  ...
  static createInterface(): CTokenInterface {
    return new Interface(_abi) as CTokenInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): CToken {
    return new Contract(address, _abi, runner) as unknown as CToken;
  }
}
