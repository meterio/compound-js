...
export interface ComptrollerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "minSuBorrowValue",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMinSuBorrowValue",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Comptroller extends BaseContract {
  ...
  getCollateralRate: TypedContractMethod<
    [collateralToken: AddressLike, liabilityToken: AddressLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "minSuBorrowValue"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "setMinSuBorrowValue"
  ): TypedContractMethod<
    [_minSuBorrowValue: BigNumberish],
    [void],
    "nonpayable"
