...
export interface SuErc20Interface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "borrowBalanceStored"
      | "borrowCollateralAndMintSynthetic"
      | "borrowIndex"
      | "borrowRatePerBlock"
      | "calcCBorrowAmount"
      | "comptroller"
  ...
  encodeFunctionData(
    functionFragment: "borrowCollateralAndMintSynthetic",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "calcCBorrowAmount",
    values: [AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface SuErc20 extends BaseContract {
  ...
  borrowCollateralAndMintSynthetic: TypedContractMethod<
    [cTokenCollateral: AddressLike, suBorrowAmount: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "borrowCollateralAndMintSynthetic"
  ): TypedContractMethod<
    [cTokenCollateral: AddressLike, suBorrowAmount: BigNumberish],
    [bigint],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "calcCBorrowAmount"
  ): TypedContractMethod<
    [cTokenCollateral: AddressLike, suBorrowAmount: BigNumberish],
    [bigint],
    "view"
