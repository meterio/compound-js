...
function markdownify(block, functionName) {
  ...
  // example
  if (tags.example) {
    const example = tags.example.replace('```', '```js').replace(/&/g, '&amp;')
    result += example + '\n\n'
  }
...
intro += '# Sumer.js\n\n'
intro += '## Introduction\n\n'
intro += '[Sumer.js](https://github.com/meterio/sumer-js) is a '
intro += 'JavaScript SDK for Ethereum and the Sumer Protocol. It wraps '
...
intro += ' message in the Development channel of the Sumer Discord.\n\n'
intro += '</section>\n\n'
