...
const patchedSignature =
  '0x5d86ab46e1f827f07e9eb6a5955eaa2219e93f64a8c8406ace0d1f48b4c0c405710fc5e9a2f8f865739e9f149ebd8a5e8a613097676385db4f197cd0ecfa85bd1c'
...
module.exports = function suite() {
  it('runs EIP712.sign as browser', async function () {
    ...
    window.ethereum.send = function (request, callback) {
      ...
      if (method === 'eth_signTypedData_v4' && params[0] === patchedAddress && params[1] === signTypedDataV4Parameter) {
    ...
    sumer._provider.getAddress = () => Promise.resolve(patchedAddress)

    const delegateSignature = await sumer.createDelegateSignature(patchedAddress)
